...
class RawHourlyMetrics(RawSchema):
    ...
    precipitation_in_mm = Column("percipitation_in_mm", Float, nullable=False)
    precipitation_probability_in_percentage = Column("percipitation_probability_in_percentage", Integer, nullable=False)
